...
_Bool TMR0_OverflowStatusGet(void);
...
void main(void) {
    ...
    uint16_t durations[42] = {
        15625, 15625, 15625, 15625, 15625, 15625, 31250,
        15625, 15625, 15625, 15625, 15625, 15625, 31250,
        15625, 15625, 15625, 15625, 15625, 15625, 31250,
        15625, 15625, 15625, 15625, 15625, 15625, 31250,
        15625, 15625, 15625, 15625, 15625, 15625, 31250,
    ...
    for (;;) {
        if (PORTAbits.RA2 == 0) {
            ...
            for (int i = 0; i < 42; i++) {
                ...
                TMR0_CounterSet((65535U) - durations[i]);
                while (TMR0_OverflowStatusGet() == 0) {
                    TMR1_OverflowStatusClear();
                    TMR1_CounterSet((65535U) - scale[notes[i]]);
                    while(TMR1_OverflowStatusGet() == 0);
                    do { LATBbits.LATB5 = ~LATBbits.LATB5; } while(0);
                }
                do { LATBbits.LATB5 = 0; } while(0);
                TMR0_OverflowStatusClear();
                TMR0_CounterSet((65535U) - 1953);
                while(TMR0_OverflowStatusGet() == 0);
            }
        }
