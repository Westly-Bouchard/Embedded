...
# 1 "./mcc_generated_files/system/../pwm/eccp1.h" 1
# 58 "./mcc_generated_files/system/../pwm/eccp1.h"
void ECCP1_Initialize(void);
# 67 "./mcc_generated_files/system/../pwm/eccp1.h"
...
# 1 "./mcc_generated_files/system/../pwm/eccp3.h" 1
# 58 "./mcc_generated_files/system/../pwm/eccp3.h"
void ECCP3_Initialize(void);
# 67 "./mcc_generated_files/system/../pwm/eccp3.h"
...
# 22 "main.c" 2
# 1 "/opt/microchip/xc8/v3.10/pic/include/c99/inttypes.h" 1 3
# 13 "/opt/microchip/xc8/v3.10/pic/include/c99/inttypes.h" 3
# 1 "/opt/microchip/xc8/v3.10/pic/include/c99/bits/alltypes.h" 1 3
# 14 "/opt/microchip/xc8/v3.10/pic/include/c99/inttypes.h" 2 3
...
#pragma warning disable 1498
    ...
    uint16_t deltaRed[6] = {0x0000, 0x0000, 0x0001, 0x0000, 0x0000, 0xFFFF};
    uint16_t deltaGre[6] = {0x0001, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000};
    uint16_t deltaBlu[6] = {0x0000, 0xFFFF, 0x0000, 0x0000, 0x0001, 0x0000};


    uint16_t initRed[6] = {0x0000, 0x0000, 0x0000, 0xFFFF, 0xFFFF, 0xFFFF};
    uint16_t initGre[6] = {0x0000, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0000};
    uint16_t initBlu[6] = {0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0xFFFF};
...
void main(void) {
    ...
    uint16_t redDuty = 135;
    uint16_t greenDuty = 135;
    uint16_t blueDuty = 135;
    uint16_t maxColorSpeed = 63536U;
    uint16_t twoFiftySixRaw = 62976U;
    uint16_t twoHundRaw = 2000U;
    uint16_t currentPeriod = 63536U;
    ...
    for (;;) {
        ...
        if (EUSART1_IsRxReady()) {
            ...
            switch (cmd) {
                ...
                case '+':
                    printf("Adding 2ms \r\n");
                    if(currentPeriod - twoHundRaw < 0) {
                        printf("Can't go any slower! \r\n");
                    } else {
                        currentPeriod-=twoHundRaw;
                        TMR0_PeriodSet(currentPeriod);
                    }
                    break;
                ...
                case 'a':
                    ...
                    ECCP1_LoadDutyValue(0);
                    ECCP2_LoadDutyValue(0);
                    ECCP3_LoadDutyValue(0);
                    break;
...
void timer0ISR(){
    ...
    if(colorTour == 1) {
        ...
        ECCP1_LoadDutyValue(currentRedValue);
        ECCP2_LoadDutyValue(currentGreenValue);
        ECCP3_LoadDutyValue(currentBlueValue);
